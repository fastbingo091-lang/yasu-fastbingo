...
const avatarIcon = { url: "/profile/avatar.png" };
const walletIcon = { url: "/profile/wallet.png" };
const depositIcon = { url: "/profile/deposit.png" };
const withdrawIcon = { url: "/profile/withdraw.png" };
const transactionsIcon = { url: "/profile/transactions.png" };
const downloadIcon = { url: "/profile/download.png" };
const logoutIcon = { url: "/profile/logout.png" };
const couponIcon = { url: "/profile/coupon.png" };
...
function AuthScreen({ onAuth, t, lang, setLang }: { onAuth: () => void; t: (k: Key) => string; lang: Lang; setLang: (l: Lang) => void }) {
  ...
  const genRefCode = (_phone: string) => `474432`;
    ...
    <div className="space-y-1">
      ...
      {status.drawing ? (
        <div className="bg-card border rounded-lg p-2 relative overflow-visible flex flex-col gap-2">
          ...
          <div className="bingo-board w-full" style={{ padding: 3, gap: 3 }}>
          ...
          <div className="bingo-board w-full">
          ...
          {/* Player's cartella — full width during calling */}
          {lockedTicketRef.current && (
            <div className="w-full rounded-md bg-white shadow-xl ring-2 ring-primary/60 p-2">
              <CartellaGrid
